<%-- 
    Document   : ActualizarNota
    Created on : 11 oct. 2021, 19:13:18
    Author     : Usuario
--%>
            ...
            <nav class="stilo navbar navbar-dark navbar-expand-xl sticky-top navigation-clean-search" style="padding: 0px;padding-top: 30px;padding-bottom: 75px;padding-right: 5px;padding-left: 10px;">
                ...
                <div class="container-fluid"><a class="navbar-brand" href="#" style="color: white;">Notas La Luz de la Luna</a><button data-toggle="collapse" class="navbar-toggler" data-target="#navcol-1"><span class="sr-only">Toggle navigation</span><span class="navbar-toggler-icon"></span></button>
                    <div class="collapse navbar-collapse" id="navcol-1">
                        ...
                        </form><img class="rounded-circle" src="${sessionScope["usuario"].getFoto()}" width="50px" height="50px" style="margin-top: 7px;"><label style="margin-right: 31px; margin-left: 11px;color: rgb(255,255,255);">${sessionScope["usuario"].getNombre()}</label>
                    </div>
                </div>>
        </header>
        <body class="fondo2">
            <form class="log fondo" method="post" action="/PIAprograweb/ServletNota" style="margin-top: 15; color: #ffffff;box-shadow: -40px 30px 20px rgba(1, 3, 12, 0.712);">
                ...
                <div ><input class="form-control" value="${param["Titulo"]}" type="text" name="Titulo" placeholder="Titulo de nota" style="background: #2102746e; color: rgb(241, 241, 241); margin: 0 auto; width: 30%;"></div>
            <div style="padding-left: 250px;"><textarea class="form-control" name="nota" name="nota" style="background: #2102746e; color: rgb(241, 241, 241); width: 70%; height: 274px; margin-top: 30px;" placeholder="Cuerpo de Nota"> ${param["Nota"]}</textarea></div>
            <div class="form-group border-light" style="padding-left: 510px;"><button class="btn btn-light btn-block" type="submit" style="background: #361ab69f;color: #ffffff;width: 25%;margin-top: 25px">Actualizar nota</button>
        </div>
            </form>
