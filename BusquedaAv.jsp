<%-- 
    Document   : BusquedaAv
    Created on : 10 nov. 2021, 16:13:00
    Author     : Usuario
--%>
...
<html lang="en">
    <head>
     ...
     <form class="log fondo" method="POST" id="FormAvanzado" action="/PIAprograweb/ServlettNota">
<div class="container">
    <div class="row" style="margin-top: 20px;">
        <h1 class="text-center" style="margin-top: 25px;margin-bottom: 15px;color: rgb(255,255,255);font-size: 20px;">Texto de Busqueda</h1>
        <div class="col-md-6"><label  id="palabras" style="color: rgb(255,255,255);">Palabras de la nota</label><input name="palabras" type="text" class="form-control"></div>
        <div class="col-md-6"><label  style="color: rgb(255,255,255);">Hashtags de la nota</label><input type="text" name="Hashtags" class="form-control"></div>
              
    </div>
</div>
<h1 class="text-center" style="margin-top: 25px;color: rgb(255,255,255);font-size: 20px;">Rango de fechas</h1>
<div class="container">
    <div class="row">
       
        <div class="col-md-3"></div>
        <div class="col-md-3"><label  style="color: rgb(255,255,255);">Fecha de inicio</label><input class="form-control" name="Fecha_ini" type="date"></div>
        <div class="col-md-3"><label  style="color: rgb(255,255,255);">Fecha fin</label><input class="form-control" name="Fecha_fin" type="date"></div>
        <div class="col-md-3"><label class="invisible" style="color: #40484f;">Label</label> </div>
        <div class="col-md-5"></div>
        <div class="col-2" >
            <button class="btn btn-primary text-center form-control " type="submit" form="FormAvanzado" style="margin-top: 30px; background: #40484f;border-style: none;">Buscar</button>
        </div>
</div>
</div>
     </form>
